...
function Methodology() {
  ...
  return (
    <section id="Methodology" className="background-1">
      ...
      <div class="center">
        El curso se desarrollará completamente en la modalidad a distancia en <b><i>Classroom</i></b> (el código de la clase es <b>{value.classroom.code}</b> y <b><a href={value.classroom.invitation} target="_blank">aquí</a></b> está la invitación) y se dividirá en dos partes:
      </div>
      <ol>
        <li>
        ...
        <li>
          Se realizarán video-reuniones, los días <b>martes, miércoles y jueves</b> a través de <b><i>Meet</i></b> (<b><a href={value.meetlink} target="_blank">aquí</a></b> el enlace de la reunión) en el horario indicado en la <b><a href={value.courselinkpageweb} target="_blank">página de la facultad</a></b>, en las que se expondrán los temas tratados en el material que se publique.
        </li>
      </ol>
      <div class="center">
